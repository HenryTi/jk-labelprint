    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk62-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk62-content-icon1">

                </div>
                <div className="ejk62-content-icon2">

                </div>
                <div className="ejk62-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk62-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk62-content-danger">
                ...
                <div className="ejk62-content-qr__code">
