    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk70-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk70-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk70-content-meta__info">
                ...
                <div className="ejk70-content-qr__code">
