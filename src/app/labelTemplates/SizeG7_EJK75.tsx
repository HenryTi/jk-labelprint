...
export function SizeG7_EJK75() {
    ...
    async function print() {
        const style = `@media print {@page {margin:0; border:0; padding:0; left: 0; } .div-box-shadow_e { box-shadow: none;} }`;
        printJS({
    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk75-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk75-content-icon1"></div>
                <div className="ejk75-content-icon2"></div>
                <div className="ejk75-content-icon3"></div>
                <div className="ejk75-content-icon4"></div>
                <div className="ejk75-content-icon5"></div>
                <div className="ejk75-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk75-content-meta__info">

                </div>
                <div className="ejk75-content-qr__code">
