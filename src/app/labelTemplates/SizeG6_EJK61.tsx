    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk61-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk61-content-icon">

                </div>
                <div className="ejk61-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk61-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk61-content-danger">
                ...
                <div className="ejk61-content-qr__code">
