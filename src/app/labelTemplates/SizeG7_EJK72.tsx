    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk72-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk72-content-icon1"></div>
                <div className="ejk72-content-icon2"></div>
                <div className="ejk72-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk72-content-meta__info">

                </div>
                <div className="ejk72-content-qr__code">
