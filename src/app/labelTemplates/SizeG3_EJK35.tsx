    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk35-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk35-content-icon1">

                </div>
                <div className="ejk35-content-icon2">

                </div>
                <div className="ejk35-content-icon3">

                </div>
                <div className="ejk35-content-icon4">

                </div>
                <div className="ejk35-content-icon5">

                </div>
                <div className="ejk35-content-info">
                    <br />
                ...
                <div className="ejk35-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk35-content-danger">
                ...
                <div className="ejk35-content-qr__code">
