...
function SizeG4_Icon(iconNum: number) {
    let result: any[] = [];
    let objSize: any = { width: "0mm", height: "0mm" };
    switch (iconNum) {
        case 0:
            result = [];
            return <></>
        case 1:
            objSize = { width: "10mm", height: "10mm" };
            result = [{ width: "10mm", height: "10mm", top: "21.96mm", left: "12.96mm", src: "" }];
            return <></>
        case 2:
            result = [{ width: "10mm", height: "10mm", top: "21.96mm", left: "12.96mm", src: "" }];
        ...
        case 5:
            result = [
                { top: "8.4mm", left: "15.94mm" },
                { top: "8.4mm", left: "42.86mm" },
                { top: "21.69mm", left: "29.4mm" },
                { top: "34.99mm", left: "15.94mm" },
                { top: "34.99mm", left: "42.86mm" },
            ];

            return <>
                {result.map((el: any, index: number) => <div id={`Icon${index + 1}`} className="position-absolute"
                    style={{ width: "10mm", height: "10mm", top: "21.96mm", left: "12.96mm" }}>
