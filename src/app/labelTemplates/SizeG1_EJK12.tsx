...
export function SizeG1_EJK12() {
    ...
    return (
        <div
            className="ejk12-content div-box-shadow_e"
            style={{ width, height }}
        >
            {iconMap
                .filter((icon: any) => {
                ...
                .map((icon: any, index: number) => {
                    return (
                        <img
                            alt="danger"
                            className={`ejk12-content-danger__icon${index + 1}`}
            ...
            />
            <ProductMetaInfo
                className="ejk12-content-meta__info"
                lotNumber={lotNumber}
                EIENCE={""}
                UN={position7}
                MF={position1}
                ...
                d={position6}
            />
            <div className="ejk12-content-danger">
                {position10}
            </div>
            <div className="ejk12-content-qr__code">
