...
export function SizeG4_EJK40() {
    ...
    return (
        <div
            className="ejk40-content div-box-shadow_e"
            style={{ width, height }}
        >
            <ProductInfo
                className="ejk40-content-info"
            ...
            />
            <ProductMetaInfo
                className="ejk40-content-meta__info"
                lotNumber={lotNumber}
                EIENCE={""}
                UN={position7}
                MF={position1}
                ...
                d={position6}
            />
            <div className="ejk40-content-danger">{position10}</div>
            <div className="ejk40-content-qr__code">
