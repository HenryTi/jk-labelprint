    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk31-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk31-content-icon">

                </div>
                <div className="ejk31-content-info">
                    <br />
                ...
                <div className="ejk31-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk31-content-danger">
                ...
                <div className="ejk31-content-qr__code">
