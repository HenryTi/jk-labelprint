...
export function SizeG4_EJK42() {
    ...
    return (
        <div
            className="ejk42-content div-box-shadow_e"
            style={{ width, height }}
        >
            {iconMap
                .filter((icon: any) => {
                ...
                .map((icon: any, index: number) => {
                    return (
                        <img
                            alt="danger"
                            className={`ejk42-content-icon${index + 1}`}
            ...
            />
            <ProductMetaInfo
                className="ejk42-content-meta__info"
                lotNumber={lotNumber}
                EIENCE={""}
                UN={position7}
                MF={position1}
                ...
                d={position6}
            />
            <div className="ejk42-content-danger">{position10}</div>
            <div className="ejk42-content-qr__code">
