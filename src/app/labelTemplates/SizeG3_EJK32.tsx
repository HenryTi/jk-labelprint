    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk32-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk32-content-icon1">

                </div>
                <div className="ejk32-content-icon2">

                </div>
                <div className="ejk32-content-info">
                    <br />
                ...
                <div className="ejk32-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk32-content-danger">
                ...
                <div className="ejk32-content-qr__code">
