    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk34-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk34-content-icon1">

                </div>
                <div className="ejk34-content-icon2">

                </div>
                <div className="ejk34-content-icon3">

                </div>
                <div className="ejk34-content-icon4">

                </div>
                <div className="ejk34-content-info">
                    <br />
                ...
                <div className="ejk34-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk34-content-danger">
                ...
                <div className="ejk34-content-qr__code">
