    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk30-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk30-content-info">
                    <br />
                ...
                <div className="ejk30-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk30-content-danger">
                ...
                <div className="ejk30-content-qr__code">
