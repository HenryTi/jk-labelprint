...
export function SizeG6_EJK65() {
    const { template, tmplContent, iconMap } = useContext<any>(CountContext);
    let { width, height } = Object.assign({ width: 140, height: 33 }, template);
    let {
        id,
        CAS,
        description, // 英文名
    ...
    return (
        <>
            ...
            <div
                ...
                className="ejk65-content div-box-shadow_e"
                style={{ width, height }}
            >
                <div className="ejk65-content-icon1"></div>
                <div className="ejk65-content-icon2"></div>
                <div className="ejk65-content-icon3"></div>
                <div className="ejk65-content-icon4"></div>
                <div className="ejk65-content-icon5"></div>
                <div className="ejk65-content-info">
                    <div>PEG-PPG-PEG, 98%, average M.W. 5,800</div>
                    <div>1L</div>
                    <div>Cat No.:302199 CAS:9003-11-6</div>
                </div>
                <div className="ejk65-content-meta__info">
                    <div>Lot:LRA0P21</div>
                    <div>d: 1.018</div>
                    <div>d: 1.018</div>
                </div>
                <div className="ejk65-content-danger">
                    Danger. Obtain special instructions before use.Avoid
                    ...
                    do.Continue rinsing. Call a POISON CENTER or
                    doctor/physician.Harmful if swallowed.Causes skin imitation.
                    Causes serious eye damage.Toxic if inhaled.May cause
                    respiratory irritation.May cause cancer.May causes damage to
                    organs through prolonged or repeated exposure.
                </div>
                <div className="ejk65-content-qr__code">
